...
BaseControl {
    ...
    // DIMENSIONS
    // ====================================================================
    property int contentWidth: checkboxBox.width + (label !== "" ? textMetrics.width + Theme.spacing.sm : 0)
    property int contentHeight: Math.max(checkboxBox.height, textMetrics.height)
